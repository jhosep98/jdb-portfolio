export const es = {
  ...
  skills: {
    ...
    mainContent:
      'Como desarrollador front-end, me especializo en el lado del cliente del desarrollo web. Mi enfoque principal es el desarrollo de aplicaciones web utilizando HTML, CSS y JavaScript (incluyendo TypeScript). Tengo experiencia construyendo aplicaciones pequeñas y medianas usando ReactJS 2+, así como creando animaciones y codificando diseños interactivos que mejoran la experiencia del usuario.',
    cards: {
      react:
      ...
      material:
        'Material UI es una libreria de componentes React de código abierto que implementa el Material Design de Google.',
      storybook:
