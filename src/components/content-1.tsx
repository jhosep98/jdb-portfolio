      ...
      <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
        <Card className="py-12">
          <CardHeader className="mb-4">
            ...
            <span className="text-center font-semibold text-xl mt-2">
              Jhosep Davila Bustamante
            </span>
        ...
        <div className="relative space-y-4">
          <p className="text-muted-foreground">
            Since 2018, I've helped 50+ founders across SaaS, AI, healthcare,
            e-commerce, dating, and more create web & apps that secure funding,
            convert users, and drive growth.
          </p>
          <p className="text-muted-foreground">
